...
let localStream;
let intervalId;
let urtcUrl = 'https://urtc.com.cn';
let logUrl = 'https://log.urtc.com.cn';
...
function stramDataTransDisplay(oldData, newData, type) {
    try{
        ...
        let temp = {
            ...
            "delay": n.video.googCurrentDelayMs ? n.video.googCurrentDelayMs : 0,
            "audio": {
                "br": 0,
        ...
        if (flag) {
            if (o.video == undefined) {
                ...
                temp = {
                    "rtt": n.googCandidatePair.googRtt,
                    "delay": n.video.googCurrentDelayMs,
                    "audio": {
            ...
            if (o.video == undefined) {
                ...
                temp = {
                    "rtt": n.googCandidatePair.googRtt,
                    "delay": n.video.googCurrentDelayMs ? 0 : 0,
                    "audio": {
